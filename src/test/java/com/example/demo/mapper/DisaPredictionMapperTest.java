...
class DisaPredictionMapperTest {
    ...
    @Test
    void queryDP() {
        DisaPrediction cr = sqlSession.selectOne("com.example.demo.mapper.DisaPredictionMapper.queryDP",1);
        System.out.println(cr.toString());
    }

    @Test
    void queryAllDPs() {
        List<DisaPrediction> ds = sqlSession.selectList("com.example.demo.mapper.DisaPredictionMapper.queryAllDPs");
    ...
    void insertDP() {
        ...
        d.setLocation("台湾省测试");
        int result = sqlSession.insert("com.example.demo.mapper.DisaPredictionMapper.insertDP",d);
        sqlSession.commit();
        if (result > 0)
